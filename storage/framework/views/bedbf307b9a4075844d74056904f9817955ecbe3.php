...
<html class="no-js" lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" dir="<?php echo e(in_array(app()->getLocale(), ['ar', 'az', 'dv', 'fa', 'he', 'ku', 'ur']) ? 'rtl' : 'ltr'); ?>">
	<head>
		...
		<meta http-equiv="Content-Security-Policy" content="default-src 'self' 'nonce-<?php echo e(app( 'aimeos.context' )->get()->nonce()); ?>' https://cdn.jsdelivr.net; style-src 'unsafe-inline' 'self' https://cdn.jsdelivr.net; img-src 'self' data: https://cdn.jsdelivr.net https://aimeos.org; frame-src https://www.youtube.com">
		...
		<link rel="icon" href="<?php echo e(asset( 'aimeos/' . ( app( 'aimeos.context' )->get()->getLocale()->getSiteItem()->getIcon() ?: '../vendor/shop/themes/default/media/aimeos-icon.png' ) )); ?>"/>
		...
		<link type="text/css" rel="stylesheet" href="<?php echo e(asset('vendor/shop/themes/default/aimeos.css')); ?>" />
	...
	<body>
		<nav class="navbar navbar-expand-md navbar-light navbar-top">
			<a class="navbar-brand" href="/" title="Logo">
				<img src="<?php echo e(asset( 'aimeos/' . ( app( 'aimeos.context' )->get()->getLocale()->getSiteItem()->getLogo() ?: '../vendor/shop/themes/default/media/aimeos.png' ) )); ?>" height="40" title="Logo">
			</a>
		...
		<script src="<?php echo e(asset('vendor/shop/themes/default/aimeos.js')); ?>"></script>
		<?php echo $__env->yieldContent('aimeos_scripts'); ?>
	</body>
</html>
<?php /**PATH /home/741765.cloudwaysapps.com/vszqmmyhkc/public_html/vendor/aimeos/aimeos-laravel/src/views/base.blade.php ENDPATH**/ ?>