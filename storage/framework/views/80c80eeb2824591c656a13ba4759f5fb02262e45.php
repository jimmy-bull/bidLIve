	...
	<body class="<?php echo e($theme); ?>">
		<div class="app-menu">
			...
			<div class="app-menu-end">
				...
				<form id="logout-form" action="<?php echo e(route( 'logout', Request::get( 'locale', app()->getLocale() ) )); ?>" method="POST"><?php echo e(csrf_field()); ?><button class="icon logout fa fa-sign-out"></button></form>
			</div>
		</div>
...
<?php /**PATH /home/741765.cloudwaysapps.com/vszqmmyhkc/public_html/vendor/aimeos/aimeos-laravel/src/views/jqadm/index.blade.php ENDPATH**/ ?>